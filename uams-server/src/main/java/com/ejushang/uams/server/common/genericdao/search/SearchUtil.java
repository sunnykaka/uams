 ...
 */
package com.ejushang.uams.server.common.genericdao.search;

import java.util.*;

import static com.ejushang.uams.server.common.genericdao.search.ISearch.*;
...
public class SearchUtil {
	...
	public static IMutableSearch shallowCopy(ISearch source) {
		return shallowCopy(source, new Search(source.getSearchClass()));
	}
	...
	public static IMutableSearch copy(ISearch source) {
		return copy(source, new Search(source.getSearchClass()));
	}
