...
Ext.define('Supplier.controller.Win', {
        ...
        init: function () {
            this.control({
                                ...
                                success: function (response) {
                                    ...
                                    if (data && data.list && responseData.success && data.list.length > 0) {
                                        ...
                                        for (var i = 0, j = data.list.length; i < j; i++) {
                                            OrderArr.push(data.list[i]['orderId']);
                                        }
                                        ...
                                        goodGrid.getStore().add(data.list[0].orderItemInspectionVos);
                ...
                "#examineGoodWin": {
                    close: function () {
                        Espide.Common.reLoadGird('OrderList', 'search');
                    }
                }
            });
        }
