...
Ext.define('Supplier.view.win.ExamineGood', {
    ...
    initComponent: function () {
        ...
        var order = Ext.create('Ext.grid.Panel', {
            ...
            store: Ext.create('Ext.data.Store', {
                fields: ["orderId", "orderNo", "shippingNo", "orderStatus", "shippingComp", "receiverName", "confirmUser", "remark", "buyerMessage"],
                proxy: {
                    type: 'ajax',
            ...
            columns: [
                ...
                {text: '订单状态', dataIndex: 'orderStatus', scope: Espide.Common.orderState, renderer: Espide.Common.orderState.getData},
        ...
        var good = Ext.create('Ext.grid.Panel', {
            ...
            store: Ext.create('Ext.data.Store', {
                fields: ["skuCode", "prodName", "orderNo", "prodCode", "categoryName", "prodPrice", "prodCount", "actuallyNumber", "brandName"],
                proxy: {
                    type: 'ajax',
                    url: '/orders',
                    reader: {
