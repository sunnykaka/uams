...
Ext.define('EBDesktop.GiftBrandActivityModel', {
    ...
    fields: ['id', 'brandId', 'brandName', 'priceBegin', 'priceEnd', 'inUse'],
    idProperty: 'id'
});
...
Ext.define('EBDesktop.gift.BrandActivity', {
    ...
    initComponent: function () {
        ...
        function showAddWin() {
            ...
            saveWin.down('[itemId=action]').setValue('/giftBrand/add');
            saveWin.show();
        }
        ...
        function showEditWin(t, record) {
            ...
            saveForm.down('[itemId=action]').setValue('/giftBrand/update');
