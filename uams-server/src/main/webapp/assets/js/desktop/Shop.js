    ...
    statics: {
        ...
        createShopGrid: function (store) {
            return Ext.create('Ext.grid.Panel', {
                ...
                tbar: {
                    items: [
                        {xtype: 'textfield', name: 'shopName', width: 150, emptyText: '请输入店铺名称', itemId: 'searchText'},
                        ...
                        {xtype: 'button', name: 'removeShop', text: '删除', handler: function (btn) {
                            var com = Espide.Common,
                                sels = com.getGridSels(btn.up('grid'), 'shopId');
                ...
                columns: [
                    ...
                    {
                        text: '店铺名称', dataIndex: 'title', width: 220
                    },
                    {
...
//                    },
                    ...
                    { name: 'outPlatformType', fieldLabel: '店铺平台', readOnly: true,
                        xtype: 'combo',
                        queryMode: 'local',
                        triggerAction: 'all',
                        forceSelection: true,
        ...
        getShopStore: function () {
            ...
            Ext.define('ShopModel', {
                ...
                fields: [
                    ...
                    'deExpress', 'enableMsg', 'msgTemp', 'msgSign', 'outPlatformType',
